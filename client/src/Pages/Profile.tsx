...
export default function Profile(): JSX.Element {
  ...
  return (
    <section className="relative h-screen mx-auto max-w-sm sm:max-w-md border border-blue-700 border-opacity-10 rounded-[25px] md:overflow-hidden md:border-opacity-30 md:flex px-3 md:mt-20 md:h-5/6 lg:h-5/6 md:max-w-3xl lg:max-w-4xl lg:mx-12 xl:max-w-4xl bg-[#010101] bg-opacity-20">
      {/* LEFT */}
      ...
      {/* MIDDLE */}
      <div className="relative md:border md:border-x-neutral-50  md:px-1 md:border-opacity-10 md:border-y-0 w-full md:flex md:justify-between md:pt-10 md:space-x-1 ">
        {/* IMAGE */}
        <div className="md:w-80 md:order-2 relative ">
          ...
          <div className="w-full absolute top-2 right-0 h-24 p-2 pt-5 md:pt-2 ">
            <nav className="flex justify-between">
              <Link to="/">
                <Button>
                  <BsArrowLeft className="text-2xl text-yellow-500 bg-[#1D252E] rounded-full p-1 md:hidden" />
                </Button>
              </Link>
        ...
        {/* PROFILE DISPLAY */}
        <div className="w-full -mt-8 opacity-90 sm:-bottom-28 md:order-1 md:w-[330px] md:h-[630px] md:flex md:flex-col justify-between md:p-1 md:mt-6 md:pr-2 lg:w-[380px] lg:h-[660px]">
