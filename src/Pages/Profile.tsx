  ...
  return (
    <section className="h-screen sm:flex sm:justify-center sm:items-center md:p-0 px-2 ">
      <section className="relative container h-screen  w-full mx-auto max-w-sm sm:max-w-md profile-border border-opacity-10 md:overflow-hidden md:flex md:mt-0 md:h-4/5 lg:h-5/6 xl:h-5/6 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl bg-[#010101] bg-opacity-0  md:bg-opacity-30 ">
        {/* LEFT */}
        <div className="hidden md:flex flex-col w-10 lg:w-16 xl:w-20 h-full justify-between pb-20 lg:pb-14 items-center pt-10">
          <Link to="/">
            <Button>
        ...
        {/* MIDDLE */}
        <div className="relative md:border md:border-x-neutral-300 md:px-2 md:border-opacity-40 md:border-y-0 w-full md:flex md:justify-between md:pt-8 lg:py-10 md:space-x-0 md:w-full lg:px-2 xl:px-5 lg:w-full">
          {/* IMAGE */}
