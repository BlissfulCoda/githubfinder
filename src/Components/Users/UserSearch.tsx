      ...
      <form className="flex" onSubmit={handleSubmit}>
        {users.length > 0 ? (
          ...
          <>
            <input
              type="text"
              className="bg-black border border-x-0 border-t-0 focus:outline-none border-b-zinc-500 text-neutral-content placeholder:text-[8px] text-base focus:placeholder:text-[7px] text-white w-28 lg:w-36"
